...
//     try {
//       const response = await axios.get(`https://localhost:7153/api/License/check-license-number/${licenseNumber}`);
...
//         isValid = false;
//       } else if (!/^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\.(com|in|io|org|net|edu|gov)$/.test(formData.email.toLowerCase()) || formData.email.length > 50 ) {
